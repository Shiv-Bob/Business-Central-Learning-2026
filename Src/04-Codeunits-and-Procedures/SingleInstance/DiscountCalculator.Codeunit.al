codeunit 50008 "Discount Calculator"
{
    ...
    begin
        ...
        SalesLineRec.SetLoadFields("No.", "Sell-to Customer No.", "Unit Price", Quantity);
        ...
        Message('Processed %1 lines.\Total discounted amount: %2\DB reads for discounts: %3', LineCount, TotalAmount, DiscountRulesCache.GetDatabaseReadCount());
